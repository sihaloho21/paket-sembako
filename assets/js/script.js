...
function showSuccessNotification(orderId, waUrl) {
    ...
    notification.innerHTML = `
        ...
        <a href="${waUrl}" class="block w-full bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-6 rounded-xl transition shadow-lg flex items-center justify-center gap-3 mt-4">
