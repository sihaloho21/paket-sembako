...
Dokumen ini menjelaskan struktur **Google Sheet** yang wajib disiapkan untuk
...
| `tanggal_pengajuan` | date/string | Tanggal submit (ISO/format tanggal) |
| `nama` | string | Nama peminjam |
| `nomor_hp` | string | Nomor WhatsApp/HP |
| `nominal` | number | Nominal pinjaman |
| `bunga_persen` | number | 5, 10, atau 20 |
...
| `tanggal_persetujuan` | date/string | Diisi saat approve/reject |
...
2. Isi header kolom di baris pertama sesuai tabel di atas.
